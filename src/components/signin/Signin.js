...
class Signin extends Component { //smart component has state (it is a class)
  constructor(props) {
    super(props);
    this.state = {
      signInEmail: '',
  ...
  onSubmitSignIn = () => { //fetch by default does a get request
    fetch('https://rocky-garden-56587.herokuapp.com/signin', {
      method: 'post',
