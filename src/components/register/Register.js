...
class Register extends Component {
  ...
  onSubmitRegister = () => { //fetch by default does a get request
    fetch('https://rocky-garden-56587.herokuapp.com/register', {
      method: 'post',
  ...
  render(){
    ...
    <article className="br3 ba b--black-10 mv4 w-100 w-50-m w-25-l mw6 shadow-5 center">
      <main className="pa4 black-80">
        <div className="measure"> {/*we do not use form because here we will work with json which is more dynamic*/}
